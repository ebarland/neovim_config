...
"                                                          Rr      Gg               gGGg  GG  G  rrrrrrrrrrrr",
"                                                          R      GG   GGGg          GGGg G   G  rrrrrrRrrrrr",
"                                                         R    R  GG  GGGg           GGGG     G  rrrrrrRrrrrr ",
"                                                    ggg.. R   R  GG  GGg             GGGG   G  rrrRrrrrrRrrr ",
...
-- Public: compute cleaned lines + ranges in Alpha's format
function M.render()
  local lines = {}
  local ranges_by_group = {} -- { [group] = { [line_index] = { {c0,c1},... } } }
  ...
  for li, line in ipairs(M.raw) do
    ...
    for group, segs in pairs(per_group) do
      ...
      for _, seg in ipairs(segs) do
        table.insert(ranges_by_group[group][li], seg)
      end
    end
  end
